...
"[project]/app/pages/api/pedido/route.tsx [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    const { mesa, itens, total } = await request.json();
    // Validação de dados
    if (!mesa || !itens || !total) {
...
async function GET() {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(pedidos);
}
}}),
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__0bffa3._.js.map