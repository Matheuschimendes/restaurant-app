...
"[project]/app/pages/api/produto/[id]/route.tsx [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        const form = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$formidable$2f$src$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].IncomingForm();
        return new Promise((resolve, reject)=>{
            form.parse(request, async (err, fields, files)=>{
                ...
                if (imagem) {
                    const imagemPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join("./public/uploads", imagem.newFilename);
                    __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].renameSync(imagem.filepath, imagemPath);
                ...
                resolve(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(novoProduto, {
                    status: 201
                }));
            });
        });
    ...
    try {
        ...
        return new Promise((resolve, reject)=>{
            form.parse(request, async (err, fields, files)=>{
                ...
                resolve(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(produtoAtualizado, {
                    status: 200
                }));
            });
        });
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__fd4bea._.js.map